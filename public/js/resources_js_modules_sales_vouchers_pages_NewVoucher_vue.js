  ...
  methods: {
    ...
    getQuotation: function getQuotation() {
      ...
      _api_BaseUrl__WEBPACK_IMPORTED_MODULE_1__["default"].get("api/sales/quotation/".concat(this.quotationSerieSelect, "/").concat(this.numberQuotation)).then(function (resp) {
        ...
        _this8.saleData.customer = quotation.customer;

        if (_this8.saleData.customer.identification_document_id == 6) {
          _this8.saleData.voucher.document_type = 1;
        }
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* HYDRATE_EVENTS, NEED_PATCH */
    ...
    trim: true
  }]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_4, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_5, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("table", {
    table: "",
