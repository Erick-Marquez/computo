    ...
    <div class="modal fade" id="new-modification" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div v-if="modification.type == 'ENTRADA' && modification.quantity != null && modification.stock != null" class="alert alert-success alert-dismissible fade show mx-3" role="alert">
                ...
                <div v-else-if="modification.type == 'SALIDA' && modification.quantity != null && modification.stock != null" class="alert alert-danger alert-dismissible fade show mx-3" role="alert">
                    <strong><i class="fas fa-exclamation-circle"></i></strong>
