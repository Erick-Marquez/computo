...
<body>
    ...
    <main>
        <div class="cliente">
            <p>Cliente <span class="cliente__puntos">:</span>{{ $head->sale->customer->name }}</p>
            <p>Num.Doc:<span class="cliente__puntos">:</span>{{ $head->sale->customer->document }}</p>
            <p>Direccion<span class="cliente__puntos">:</span>{{ $head->sale->customer->address }}</p>
        </div>
        ...
        <table class="pagar">
            ...
            <tbody class="detalle">
                ...
                @endforeach
                <tr class="tfood">
                    <td colspan="6"> SON {{ \App\Services\NumberLetterService::convert(round($head->total, 2), 'SOLES') }}</td>
                </tr>
            </tbody>
        </table>
            ...
            <tr>
                ...
                <td>
                    <div class="resumen">
                        ...
                        <div class="resumen__elemento">
                            <p>Total:</p>
                            <p class="total__precio">S/ {{ round($head->total, 2) }}</p>
                        </div>
                    </div>
                </td>
            </tr>
