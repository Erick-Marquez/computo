...
@section('content')
    <div class="card">
        <div class="card-header">
            <a class="btn btn-secondary" href="{{ route('quotations.create') }}">Nuevo</a>
        </div>
        <div class="card-body">
            <table class="table table-striped">
                ...
                <tbody>
                    @foreach ($quotations as $quotation)
                        <tr>
                            <td>{{ str_pad($quotation->document_number, 8, '0', STR_PAD_LEFT) }}</td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="{{ route('quotations.show', $quotation) }}"><i
                                                class="col-1 mr-3 fas fa-eye"></i>Mostrar</a>
                                        @can('quotations.edit')
                                            <a class="dropdown-item" href="{{ route('quotations.edit', $quotation) }}"><i
